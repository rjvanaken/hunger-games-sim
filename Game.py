...
class Game():
    ...
    def setupArenaLayout(self, arena, train=False):
        ...
        if train:
            hazard_positions = [
                # near upper-left water
                (3, 5), (3, 10), (8, 5), (8, 10),
                # near upper-right water
                (2, 37), (2, 42), (7, 37), (7, 42),
                # near mid-left water
                (21, 7), (25, 7), (21, 11), (25, 11),
                # near mid-right water
                (21, 38), (25, 38), (21, 42), (25, 42),
                # near bottom-center water
                (37, 20), (37, 27), (43, 20), (43, 27),
                # near center-bottom-left water
                (29, 9), (33, 9), (29, 13), (33, 13),
                # near center-bottom-right water
                (29, 36), (33, 36), (29, 40), (33, 40),
                # near food clusters
                (5, 15), (5, 28), (17, 4), (17, 41),
                (32, 4), (32, 41), (42, 15), (42, 28),
                # center-left freed space - spread out, not a block
                (17, 21), (18, 23),
                # center-right freed space
                (23, 30), (25, 31),
                # left side
